...
alias ig='dnf list --installed | grep' # szukanie zainstalowanego pakietu po nazwie
alias ia='dnf list --installed' # lista wszystkich zainstalowanych pakietów
alias iip='dnf info' # informacje o zainstalowanym pakiecie
