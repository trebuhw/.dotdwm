...
# pętlą: Enter stosuje tapetę i OD RAZU otwiera rofi ponownie - wygląda
# jak "nie zamknęło się", dając podgląd na żywo kolejnych tapet.
# Escape -> puste "selected" (zweryfikowane) -> wychodzimy z pętli,
# rofi faktycznie się zamyka.
while true; do
    selected=$(
