...
BACKUP_ITEMS_BUILTIN=(
  "DOCUMENTS|$HOME/Documents|Documents|--exclude=tmp --exclude=sekret.txt|distro|Katalog ~/Documents|ON"
  "TEMPLATES|$HOME/Templates|Templates||distro|Katalog ~/Szablony|ON"
  ...
  "ONEDRIVE|$HOME/OneDrive|OneDrive||cloud|Kopia folderu ~/OneDrive|OFF"
